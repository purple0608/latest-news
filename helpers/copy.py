...
'cookie': 'geoinfo=CC:IN, RC:AP, CT:VIJAYAWADA, CO:AS, GL:1; _hookShow=1; fpid=e6fa72b2ee247adafaca00381f2799c41672659246; pfuuid=1644912066746711; popout_autorefresh_open=true; rw_default=true; g_state={"i_p":1673011398744,"i_l":2}; et_interstitial_active=true; int_fcapcount=5',
...
def Economictimes_news():
    ...
    try:
        ...
        latest_news = soup.select('#topNewsTabs > div.tabsContent.clearfix > ul > li.tc_latest')
        content = str(latest_news[0])
        # print(latest_news)
